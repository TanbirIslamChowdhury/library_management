		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-header align-center">
					...
					<h2 class="section-title">Books On offer</h2>
				</div>
