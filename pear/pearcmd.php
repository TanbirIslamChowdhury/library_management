...
if ('D:\idb wdpf 64\php\xampp8.2.12\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\idb wdpf 64\php\xampp8.2.12\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
