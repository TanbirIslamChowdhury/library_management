...
FOR %%x IN ("D:\idb wdpf 64\php\xampp8.2.12\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\idb wdpf 64\php\xampp8.2.12\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\idb wdpf 64\php\xampp8.2.12\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\idb wdpf 64\php\xampp8.2.12\php\php.exe"
GOTO :INSTALLED
